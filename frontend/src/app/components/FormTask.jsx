...
function ListTask(){
    ...
    return(
        <div className = 'bg-slate-200 p-7 h-fit'>
            ...
            <label htmlFor="title" className="text-xs text-black">Titulo:</label>
            <input type="text" name="title" 
                className= "bg-slate-400 rounded-md p-2  mb-2 block w-full text-slate-900" onChange={e => setTitle(e.target.value)}/>
            <label htmlFor="description" className="text-xs text-black">Description:</label>
            <textarea name="description" 
                className= "bg-slate-400 rounded-md p-2  mb-2 block w-full text-slate-900" onChange={e => setDescription(e.target.value)}></textarea>
